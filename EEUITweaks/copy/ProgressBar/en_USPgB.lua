...
-- Progress bar options strings
	...
	PROGBAROPT_GREY_SCALE_DUAL_DESCR = "When selected, dual class characters' initial class progress bar will be painted using grey scale rather than the Filling/Full color scheme.",
	...
	PROGBAROPT_BARS_BOTTOM_LABEL = "Portrait Above Progress Bars",
	PROGBAROPT_BARS_BOTTOM_DESCR = "When selected, the small portrait and optional stats summary will be positioned above the progress bar(s) in the alternate display.",
	...
	PROGBAROPT_INIT_ALTPORT_DESCR = "Progress bars, small portrat, and optional stats summary will be initially displayed.",
